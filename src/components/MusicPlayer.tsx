...
import MashGroup23 from '../assets/Mask Group 23.png';
import path from '../assets/path.png'
import Group9 from '../assets/Group 9.png';

const MusicPlayer: FC = () => {
  return <div className="musicPlayer flex flex-col px-5 w-[100%] border-2 border-black py-3 bg-[#232A4E] rounded-xl mt-5">
    {/*upperPart*/}
    <div className="upperPart flex items-center justify-between">
      {/*profile*/}
      <div className="profile flex">
        <img src={MashGroup23} alt="mash group 23 image" className={'w-[2.5rem] h-[2.5rem] border-2 border-white rounded-full'}/>
        <div className="details flex flex-col ml-4">
          <span className="text-[1rem]">Tristam Bone Dry</span>
          <span className={"test-sm text-gray-500"}>Unknown Artist</span>
        </div>
      </div>

      <div>
        <img src={path} alt="path icon" className={"h-[1rem]"} />
      </div>
    </div>
